...
ggsave("Fig3.jpg", plot_m_heatmap, width = 14, height = 7 )
...
combined_plot <- (ES_1WEEK | ES_2WEEK) /
                 (ES_3WEEK | ES_4WEEK) + 
  plot_annotation(
    title = "Figure X: Mean WIS differences (%) compared to the baseline",
...
# Save to file
ggsave("Fig5.jpg", combined_plot, width =12, height =7)
```
