...
combined_plot <- (plt1 | plt2) + 
  plot_annotation(
    title = "Figure X: Mean WIS for our 24 models",
...
# Save to file
ggsave("Fig1.jpg", combined_plot, width =13, height =7)
```
...
combined_plot <- (ES_1WEEK | ES_2WEEK) /
                 (ES_3WEEK | ES_4WEEK) + 
  plot_annotation(
    title = "Figure X: Mean WIS for the 48 states in the contiguous U.S.",
...
# Save to file
ggsave("Fig4.jpg", combined_plot, width =12, height =7)
