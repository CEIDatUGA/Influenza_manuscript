...
plt00 <- ggplot(forecast_df, aes(x = Week, y = Value, group = 1)) +
  ...
  labs(title = "Example of influenza hospitalizaions forecasts with 95% confidence intervals",
       x = "Target Weeks",
       y = "Forecast Values") +
  theme_minimal()
...
ggsave(plt00, height = 5, width = 6, filename="fig00.jpg") 
```
...
plt1<-  ggplot(combined_data, aes(x = week, y = value, fill = Models)) +
    ...
    facet_wrap(category ~ Models , nrow = 3) +
    labs(
...
calculate_mean_wis <- function(data) {
  data %>%
    ...
    summarize(
      ...
      AUTO_AVG_Lg = mean(AUTO_AVG, na.rm = TRUE),
      ...
      ES27_AVG_Lg = mean(ES27_AVG, na.rm = TRUE),
      ...
      ES64_AVG_Lg = mean(ES64_AVG, na.rm = TRUE),
...
combined_data <- data.frame(
  ...
  Models = rep(c("AUTO_AR_Lg", "ES27_AR_Lg", "ES64_AR_Lg", "AUTO_ADJ_Lg", "ES27_ADJ_Lg", "ES64_ADJ_Lg", "AUTO_TMP_Lg", "ES27_TMP_Lg", "ES64_TMP_Lg", "AUTO_EPI_Lg", "ES27_EPI_Lg", "ES64_EPI_Lg", "AUTO_AVG_Lg", "ES27_AVG_Lg", "ES64_AVG_Lg"), each=48, times = 4),
  
  value = c(W1_Lg$AUTO_AR_Lg, W1_Lg$ES27_AR_Lg, W1_Lg$ES64_AR_Lg, 
            W1_Lg$AUTO_ADJ_Lg, W1_Lg$ES27_ADJ_Lg, W1_Lg$ES64_ADJ_Lg, 
            W1_Lg$AUTO_TMP_Lg, W1_Lg$ES27_TMP_Lg, W1_Lg$ES64_TMP_Lg, 
            W1_Lg$AUTO_EPI_Lg, W1_Lg$ES27_EPI_Lg, W1_Lg$ES64_EPI_Lg,
            W1_Lg$AUTO_AVG_Lg, W1_Lg$ES27_AVG_Lg, W1_Lg$ES64_AVG_Lg,
            
            W2_Lg$AUTO_AR_Lg, W2_Lg$ES27_AR_Lg, W2_Lg$ES64_AR_Lg, 
            W2_Lg$AUTO_ADJ_Lg, W2_Lg$ES27_ADJ_Lg, W2_Lg$ES64_ADJ_Lg, 
            W2_Lg$AUTO_TMP_Lg, W2_Lg$ES27_TMP_Lg, W2_Lg$ES64_TMP_Lg, 
            W2_Lg$AUTO_EPI_Lg, W2_Lg$ES27_EPI_Lg, W2_Lg$ES64_EPI_Lg,
            W2_Lg$AUTO_AVG_Lg, W2_Lg$ES27_AVG_Lg, W2_Lg$ES64_AVG_Lg,            
            
            W3_Lg$AUTO_AR_Lg, W3_Lg$ES27_AR_Lg, W3_Lg$ES64_AR_Lg, 
            W3_Lg$AUTO_ADJ_Lg, W3_Lg$ES27_ADJ_Lg, W3_Lg$ES64_ADJ_Lg, 
            W3_Lg$AUTO_TMP_Lg, W3_Lg$ES27_TMP_Lg, W3_Lg$ES64_TMP_Lg, 
            W3_Lg$AUTO_EPI_Lg, W3_Lg$ES27_EPI_Lg, W3_Lg$ES64_EPI_Lg,
            W3_Lg$AUTO_AVG_Lg, W3_Lg$ES27_AVG_Lg, W3_Lg$ES64_AVG_Lg,
            
            
            W4_Lg$AUTO_AR_Lg, W4_Lg$ES27_AR_Lg, W4_Lg$ES64_AR_Lg, 
            W4_Lg$AUTO_ADJ_Lg, W4_Lg$ES27_ADJ_Lg, W4_Lg$ES64_ADJ_Lg, 
            W4_Lg$AUTO_TMP_Lg, W4_Lg$ES27_TMP_Lg, W4_Lg$ES64_TMP_Lg, 
            W4_Lg$AUTO_EPI_Lg, W4_Lg$ES27_EPI_Lg, W4_Lg$ES64_EPI_Lg,
            W4_Lg$AUTO_AVG_Lg, W4_Lg$ES27_AVG_Lg, W4_Lg$ES64_AVG_Lg)
...
custom_colors <- c(
  ...
  "AUTO_AVG_Lg" = colors_avg[1], "ES27_AVG_Lg" = colors_avg[2], "ES64_AVG_Lg" = colors_avg[3]
)
...
custom_colors <- c(
  ...
  "AUTO_AVG_NoLg" = colors_avg[1], "ES27_AVG_NoLg" = colors_avg[2], "ES64_AVG_NoLg" = colors_avg[3]
)
...
wilcox_results <- map_df(model_types, function(model) {
  test <- wilcox.test(wide_data[[model]], wide_data$AUTO_AR_NoLg, paired = TRUE)
...
calculate_percentage_of_improvement <- function(data) {
  return(data.frame(
    ...
    ES27_AR_NoLg = ((1 - (data$ES27_AR_NoLg/data$AUTO_AR_NoLg)) * 100),
    ES64_AR_NoLg = ((1 - (data$ES64_AR_NoLg/data$AUTO_AR_NoLg )) * 100),
   
    AUTO_ADJ_NoLg = ((1 - (data$AUTO_ADJ_NoLg/data$AUTO_AR_NoLg)) * 100),
    ES27_ADJ_NoLg = ((1 - (data$ES27_ADJ_NoLg/data$AUTO_AR_NoLg)) * 100),
    ES64_ADJ_NoLg = ((1 - (data$ES64_ADJ_NoLg/data$AUTO_AR_NoLg)) * 100),
    
    AUTO_TMP_NoLg = ((1 - (data$AUTO_TMP_NoLg/data$AUTO_AR_NoLg)) * 100),
    ES27_TMP_NoLg = ((1 - (data$ES27_TMP_NoLg/data$AUTO_AR_NoLg)) * 100),
    ES64_TMP_NoLg = ((1 - (data$ES64_TMP_NoLg/data$AUTO_AR_NoLg)) * 100),
    
    AUTO_EPI_NoLg = ((1 - (data$AUTO_EPI_NoLg/data$AUTO_AR_NoLg)) * 100),
    ES27_EPI_NoLg = ((1 - (data$ES27_EPI_NoLg/data$AUTO_AR_NoLg)) * 100),
    ES64_EPI_NoLg = ((1 - (data$ES64_EPI_NoLg/data$AUTO_AR_NoLg)) * 100),
    
    AUTO_AVG_NoLg = ((1 - (data$AUTO_AVG_NoLg/data$AUTO_AR_NoLg)) * 100),
    ES27_AVG_NoLg = ((1 - (data$ES27_AVG_NoLg/data$AUTO_AR_NoLg)) * 100),
    ES64_AVG_NoLg = ((1 - (data$ES64_AVG_NoLg/data$AUTO_AR_NoLg)) * 100),
    
    AUTO_AR_Lg = ((1 - (data$AUTO_AR_Lg/data$AUTO_AR_NoLg)) * 100),
    ES27_AR_Lg = ((1 - (data$ES27_AR_Lg/data$AUTO_AR_NoLg)) * 100),
    ES64_AR_Lg = ((1 - (data$ES64_AR_Lg/data$AUTO_AR_NoLg)) * 100),
    
    AUTO_ADJ_Lg = ((1 - (data$AUTO_ADJ_Lg/data$AUTO_AR_NoLg)) * 100),
    ES27_ADJ_Lg = ((1 - (data$ES27_ADJ_Lg/data$AUTO_AR_NoLg)) * 100),
    ES64_ADJ_Lg = ((1 - (data$ES64_ADJ_Lg/data$AUTO_AR_NoLg)) * 100),
    
    AUTO_TMP_Lg = ((1 - (data$AUTO_TMP_Lg/data$AUTO_AR_NoLg)) * 100),
    ES27_TMP_Lg = ((1 - (data$ES27_TMP_Lg/data$AUTO_AR_NoLg)) * 100),
    ES64_TMP_Lg = ((1 - (data$ES64_TMP_Lg/data$AUTO_AR_NoLg)) * 100),
    
    AUTO_EPI_Lg = ((1 - (data$AUTO_EPI_Lg/data$AUTO_AR_NoLg)) * 100),
    ES27_EPI_Lg = ((1 - (data$ES27_EPI_Lg/data$AUTO_AR_NoLg)) * 100),
    ES64_EPI_Lg = ((1 - (data$ES64_EPI_Lg/data$AUTO_AR_NoLg)) * 100),
    
    AUTO_AVG_Lg = ((1 - (data$AUTO_AVG_Lg/data$AUTO_AR_NoLg)) * 100),
    ES27_AVG_Lg = ((1 - (data$ES27_AVG_Lg/data$AUTO_AR_NoLg)) * 100),
    ES64_AVG_Lg = ((1 - (data$ES64_AVG_Lg/data$AUTO_AR_NoLg)) * 100)    
  ))
}
...
plot_m_heatmap <- ggplot(p_df, aes(x = factor(WeekAhead), y = Model, fill = m)) +
  ...
  scale_fill_gradient(low = "red", high = "cyan", na.value = "gray80", 
                      name = "Percentage (%)", limits = c(-35, 35)) +  # Fixed color scale from -30 to 30
  labs(title = "Figure X: Mean differences between models' WIS and the baseline across 48 states",
...
W1_map <- data.frame(
  STATE = W1$STATE,
  percentage_improvement = W1_percentage_of_improvement$AUTO_AVG_Lg,
  AUTO_AVG=W1$AUTO_AVG_Lg
)
...
W2_map <- data.frame(
  STATE = W2$STATE,
  percentage_improvement = W2_percentage_of_improvement$AUTO_AVG_Lg,
  AUTO_AVG=W2$AUTO_AVG_Lg
)
...
W3_map <- data.frame(
  STATE = W3$STATE,
  percentage_improvement = W3_percentage_of_improvement$AUTO_AVG_Lg,
  AUTO_AVG=W3$AUTO_AVG_Lg
)
...
W4_map <- data.frame(
  STATE = W4$STATE,
  percentage_improvement = W4_percentage_of_improvement$AUTO_AVG_Lg,
  AUTO_AVG=W4$AUTO_AVG_Lg
)
...
ES_1WEEK <- ggplot(W1_map) +
  ...
  geom_sf_text(data = W1_map, aes(label = round(AUTO_AVG,1)),  # Round to whole numbers
               size = 3,
               color = "black",
...
ES_2WEEK <- ggplot(W2_map) +
  ...
  theme_light() +
  theme(legend.position = "right") +
  geom_sf_text(data = W2_map, aes(label = round(AUTO_AVG,1)),  # Round to whole numbers
               size = 3,
               color = "black",
               check_overlap = TRUE) +  # Display percentage improvement in each state
  labs(
...
ES_3WEEK <- ggplot(W3_map) +
  ...
  theme_light() +
  theme(legend.position = "right") +
  geom_sf_text(data = W3_map, aes(label = round(AUTO_AVG,1)),  # Round to whole numbers
               size = 3,
               color = "black",
               check_overlap = TRUE) +  # Display percentage improvement in each state
  labs(
...
ES_4WEEK <- ggplot(W4_map) +
  ...
  theme_light() +
  theme(legend.position = "right") +
  geom_sf_text(data = W4_map, aes(label = round(AUTO_AVG,1)),  
               size = 3,
               color = "black",
               check_overlap = TRUE) +
  labs(
...
ES_1WEEK <- ggplot(W1_map) +
  ...
  scale_fill_gradient2(low = "darkred", mid = "lightyellow", high = "skyblue", midpoint = 0, limits = c(-30, 60)) +  
  ...
  labs(
    ...
    subtitle = "(1-(Baseline/AUTO_AVG_LB))*100"
            , 
       x = "",
       y = ""
  )  # Adding a subtitle
...
for (week in weeks) {
  ...
  summed_data <- data__ %>%
    ...
    summarize(
      ...
      AUTO_AVG = sum(AUTO_AVG, na.rm = TRUE)           # Sum across all states
    ) %>%
    # Calculate the difference ratio
    mutate(Difference = 1 - (AUTO_AVG / AUTO_AR_NoLg),
...
model_improv<-ggplot(summed_data_all, aes(x = Julian_date, y = (Difference)*100, color = Week)) +
  geom_point(size = 3) +
  geom_hline(yintercept = 0, color = "black", linetype = "dashed", size = 0.8) +
  theme_minimal() +
  labs(
    title = "Figure X: Mean percentage of WIS differences across all states",
...
ggsave(model_improv, height = 4.5, width = 9,  filename="Fig6.jpg")  
```