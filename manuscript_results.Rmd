...
# Create a new column "Model_Type" based on model with and withouth log-back transformation
...
Let's plot some maps with the with the mean difference (%) between the AUTO_AVG and the AUTO ARIMA models for the same state.
...
Computing and plotting mean WIS improvement by epidemiological weeks.
