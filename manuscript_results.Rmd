...
plt00 <- ggplot(forecast_df, aes(x = Week, y = Value, group = 1)) +
  ...
  labs(title = "Figure X: Example of influenza hospitalizaions forecasts",
...
ggsave(plt00, height = 5, width = 10, filename="fig00.jpg") 
```
...
plt0 <- ggplot(df_combined_, aes(x = Julian_date, y = WIS, group = STATE)) + 
  ...
  theme_minimal() +  
  labs(title = "Figure X: Baseline model WIS for 48 states on the contiguous U.S.",#,
...
ggsave(plt0, height = 5, width = 8, filename="fig0.jpg")  
```
...
combined_plot <- ggplot(all_weeks, aes(x = Best_Result, fill = Best_Result)) +
  geom_bar() +
  scale_fill_manual(values = custom_colors) +
  labs(title = "Figure X: Best model based on the lowest mean WIS",
       subtitle = "Across the 48 states on the contiguous U.S.",
       x = "", y = "Number of states",
       fill = "Best model" ) +
  theme(axis.text.x = element_text(angle = 45, hjust = 1),
        plot.title = element_text(size = 16, face = "bold")) +
...
ggsave("Fig2.jpg", combined_plot, width =8, height =5)
print(combined_plot)
...
calculate_percentage_of_improvement <- function(data) {
  return(data.frame(
    ...
    ES27_AR = (-(1 - (data$ES27_AR/data$AUTO_AR)) * 100),
    ES64_AR = (-(1 - (data$ES64_AR/data$AUTO_AR )) * 100),
   
    AUTO_ADJ = (-(1 - (data$AUTO_ADJ/data$AUTO_AR)) * 100),
    ES27_ADJ = (-(1 - (data$ES27_ADJ/data$AUTO_AR)) * 100),
    ES64_ADJ = (-(1 - (data$ES64_ADJ/data$AUTO_AR)) * 100),
    
    AUTO_TMP = (-(1 - (data$AUTO_TMP/data$AUTO_AR)) * 100),
    ES27_TMP = (-(1 - (data$ES27_TMP/data$AUTO_AR)) * 100),
    ES64_TMP = (-(1 - (data$ES64_TMP/data$AUTO_AR)) * 100),
    
    AUTO_EPI = (-(1 - (data$AUTO_EPI/data$AUTO_AR)) * 100),
    ES27_EPI = (-(1 - (data$ES27_EPI/data$AUTO_AR)) * 100),
    ES64_EPI = (-(1 - (data$ES64_EPI/data$AUTO_AR)) * 100),
    
    AUTO_AVG = (-(1 - (data$AUTO_AVG/data$AUTO_AR)) * 100),
    ES27_AVG = (-(1 - (data$ES27_AVG/data$AUTO_AR)) * 100),
    ES64_AVG = (-(1 - (data$ES64_AVG/data$AUTO_AR)) * 100),
    
    AUTO_AR_LB = (-(1 - (data$AUTO_AR_LB/data$AUTO_AR)) * 100),
    ES27_AR_LB = (-(1 - (data$ES27_AR_LB/data$AUTO_AR)) * 100),
    ES64_AR_LB = (-(1 - (data$ES64_AR_LB/data$AUTO_AR)) * 100),
    
    AUTO_ADJ_LB = (-(1 - (data$AUTO_ADJ_LB/data$AUTO_AR)) * 100),
    ES27_ADJ_LB = (-(1 - (data$ES27_ADJ_LB/data$AUTO_AR)) * 100),
    ES64_ADJ_LB = (-(1 - (data$ES64_ADJ_LB/data$AUTO_AR)) * 100),
    
    AUTO_TMP_LB = (-(1 - (data$AUTO_TMP_LB/data$AUTO_AR)) * 100),
    ES27_TMP_LB = (-(1 - (data$ES27_TMP_LB/data$AUTO_AR)) * 100),
    ES64_TMP_LB = (-(1 - (data$ES64_TMP_LB/data$AUTO_AR)) * 100),
    
    AUTO_EPI_LB = (-(1 - (data$AUTO_EPI_LB/data$AUTO_AR)) * 100),
    ES27_EPI_LB = (-(1 - (data$ES27_EPI_LB/data$AUTO_AR)) * 100),
    ES64_EPI_LB = (-(1 - (data$ES64_EPI_LB/data$AUTO_AR)) * 100),
    
    AUTO_AVG_LB = (-(1 - (data$AUTO_AVG_LB/data$AUTO_AR)) * 100),
    ES27_AVG_LB = (-(1 - (data$ES27_AVG_LB/data$AUTO_AR)) * 100),
    ES64_AVG_LB = (-(1 - (data$ES64_AVG_LB/data$AUTO_AR)) * 100)    
  ))
}
...
plot_m_heatmap <- ggplot(p_df, aes(x = factor(WeekAhead), y = Model, fill = m)) +
  ...
  scale_fill_gradient(low = "cyan", high = "red", na.value = "gray80", 
...
# Save to file
ggsave("Fig5_2x2_combined.jpg", combined_plot, width = 15, height = 8)
```
...
for (week in weeks) {
  ...
  summed_data <- data__ %>%
    ...
    summarize(
      AUTO_AR = sum(AUTO_AR, na.rm = TRUE),  # Sum across all states
      AUTO_AVG_LB = sum(AUTO_AVG_LB, na.rm = TRUE)           # Sum across all states
    ) %>%
