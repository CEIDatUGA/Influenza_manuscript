...
Datasets with mean differences, standard deviations and Wilcoxon Holm adjusted p-values
...
model_approaches <- model_approaches %>%
  mutate(Family = ifelse(Family == "AR", "AAR", Family)) # rename because the intercept is in alphabetic order and I want to use the baseline
