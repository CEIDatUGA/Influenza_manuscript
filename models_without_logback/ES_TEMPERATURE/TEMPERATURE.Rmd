---
title: "TEMPERATURE ARIMAX MODELS - without log-back transformations"
author: "Victor Felix"
...
# Loads the model
source("ES_TEMPERATURE_nolog.R", local = TRUE, chdir = TRUE)
...
```{r}
save.image("TEMPERATURE_MODELS_influenza_hospitalization_nolog.Rdata")
```
